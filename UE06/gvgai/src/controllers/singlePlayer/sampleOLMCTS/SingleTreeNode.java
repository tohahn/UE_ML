...
public class SingleTreeNode
{
    ...
    private final double PEN_OA = 0.1;
    private final double PEN_BM = 100;
    ...
    public double rollOut(StateObservation state)
    {
        ...
        Types.ACTIONS last = null;
        Types.ACTIONS secondToLast = null;
        ...
        double delta = value(state, last, secondToLast);
