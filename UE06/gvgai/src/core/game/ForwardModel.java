...
public class ForwardModel extends Game
{
    ...
    /**
     * Constants for pheromone diffusion
     */
    private final float PDF = 0.4f;
    private final float PDC = 0.99f;
    ...
    private void initNonVolatile(Game a_gameState)
    {
        ...
        this.pheromones = new float[(int) this.size.getHeight()][(int) this.size.getWidth()];
    ...
    protected void updateAvatars(Types.ACTIONS action, int playerID)
    {
        ...
        if (!a.is_disabled()) {
            ...
            if (a.getPosition().x > 0) {
            	x = (int) (a.getPosition().x - 1);
            }
            if (a.getPosition().y > 0) {
            	y = (int) (a.getPosition().y - 1);
            }
            this.pheromones[(int) (y / block_size)][(int) (x / block_size)] = 1;
    ...
    */
	...
	public float getPheromones() {
        ...
        return this.pheromones[(int) (y / block_size)][(int) (x / block_size)];
	}
