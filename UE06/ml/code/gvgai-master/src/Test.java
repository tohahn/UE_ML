...
public class Test
{
    ...
    public static void main(String[] args)
    {
        ...
        String games[] = new String[]{"aliens", "frogs","boulderdash", "butterflies", "chase", "missilecommand", "portals", "sokoban", "survivezombies", "zelda"};
 ...
 //       int N = 10, L = 5, M = 2;
	    ...
	    // ArcadeMachine.runOneGame(game, levels, true, sampleMCTSController, saveActions? actionFiles:null, seed);
	    ArcadeMachine.runOneGame(game, levels[j], true, sampleGAController, null, seed);
            }
